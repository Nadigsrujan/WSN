...
function App() {
    ...
    const { graph, current_path, alt_path, metrics, rl, nodes, newly_dead, step, routing_table, event_log, ch_events } = data;
                ...
                <aside className="sidebar">
                    ...
                    <div className="sidebar-section">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '13px' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: 12, height: 12, borderRadius: '50%', background: '#a855f7', border: '1px solid #c084fc' }}></div> Cluster Head (Appointed)</div>
